...
<body>
    ...
    <div class="container">
		...
		<section id="home-slider">
			<div class="container">				
				<div class="row">
					<h1 class="title text-center wow fadeInDown" data-wow-duration="500ms" data-wow-delay="300ms">松山智慧交通預測服務</h1>
					<p class="text-center wow fadeInDown" data-wow-duration="400ms" data-wow-delay="400ms" style="font-size:120%;">Songshan Intelligent Traffic Prediction Service</p>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<h2 class="page-header">塞車機率 / <a href="service_songshan_time_zh_TW.html">其他查詢條件</a> / <a href="service_songshan_zh_TW.php">其他松山路段</a> / <a href="../service_zh_TW.html">其他行政區域</a></h2>
					</div>
				...
				/* 透過SQL Query找出剩下所需要的vd,position,direction資訊 */	
					$sqlinformation =  "select vd 'vd',position 'position',direction 'direction',jampercent 'jampercent',congest 'congest' from cj20170227 where district ='Songshan' and road ='$road' and weekday='$weekday' and time='$time' group by position,direction";	
...
/* 					echo " <div class=\"col-md-3 wow fadeIn\" data-wow-duration=\"1000ms\" data-wow-delay=\"300ms\"> ";
				...
				?>																														
					...
					<div class="controls col-lg-12 text-center" style="height:60px;margin-top:25px;">
						<input type="button" value="返回" style="width:22%;" onclick="location.href='service_songshan_time_zh_TW.html'"/>
					</div>

    ...
    <div class="container">
		...
		<section id="home-slider">
			<div class="container">				
				...
				<div class="row">
					<div class="col-lg-12">
						<h2 class="page-header">塞車機率 / <a href="service_neihu_time.html">其他查詢條件</a> / <a href="service_neihu.php">其他內湖路段</a> / <a href="../service.html">其他行政區域</a></h2>
					</div>
...
/* 					echo " <div class=\"col-md-3 wow fadeIn\" data-wow-duration=\"1000ms\" data-wow-delay=\"300ms\"> ";
				...
				?>																														
					...
					<div class="controls col-lg-12 text-center" style="height:60px;margin-top:25px;">
						<input type="button" value="返回" style="width:22%;" onclick="location.href='service_neihu_time.html'"/>
					</div>

    ...
    <div class="container">
		...
		<section id="home-slider">
			<div class="container">				
				...
				<div class="row">
					<div class="col-lg-12">
						<h2 class="page-header">信義路段選擇 / <a href="../service_zh_TW.html">其他行政區域</a></h2>
					</div>
					<script type="text/javascript">
						function roadtonewpage(objButton){
							location.href='service_xinyi_time_zh_TW.html';
							sessionStorage.setItem("road",objButton.value);																				
						}
					</script>					
					<?php
						include("../mysql.inc.php");								
						$sqlroad = "select road 'road' from cj20170227 where district ='Xinyi' group by road";	
